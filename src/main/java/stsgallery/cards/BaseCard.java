...
import stsgallery.STSGalleryMod;
import stsgallery.util.CardStats;
import stsgallery.util.TriFunction;
...
import static stsgallery.util.GeneralUtils.removePrefix;
import static stsgallery.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return STSGalleryMod.makeID(name); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    STSGalleryMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
