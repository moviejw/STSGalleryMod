package stsgallery.achievements;
...
public class GalleryAchievements extends AchievementItem {
    ...
    public GalleryAchievements(String title, String desc, String key, boolean hidden, TextureAtlas.AtlasRegion unlockedImage, TextureAtlas.AtlasRegion lockedImage) {
